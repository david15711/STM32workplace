/* ============================================================================ */
/*    Exp21_4_interrupt(200).c : CAN 2.0A 인터럽트 수신 - 200번 ID측 프로그램	*/
/* ============================================================================ */
...
void CAN1_RX0_IRQHandler(void);			/* CAN1 interrupt */
...
unsigned int  TX_ID = 200, TX_DLC = 8;		// transmit information(송신측 ID=200)
unsigned int  RX_ID = 100, RX_DLC = 8;		// receive information(수신측 ID=100)
