/* ============================================================================ */
/*   Exp17_7_analog_landscape.c : DS3234를 이용한 아날로그 시계 - 풍경화 모드	*/
/* ============================================================================ */
...
void Draw_analog_clock(void)			/* draw analog clock */
{
 ...
 Rectangle(0,0,319,239,Brown);			// draw outline
