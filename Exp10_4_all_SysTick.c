/* ============================================================================ */
/*    Exp10_4_all_SysTick.c : 삼성전자/LG전자 겸용 TV 리모컨 입력 프로그램	*/
/* ============================================================================ */
...
// SS_Leader_Code	= 243000		// 9ms / 37.0ns = 243000
// LG_Leader_Code	= 354500		// 13.5ms / 37.0nus = 364500
// Low_Bit		= 30375			// 1.125ms / 37.0ns = 30375
// High_Bit		= 60750			// 2.25ms / 37.0ns = 60750

#define ARR_value	437400			// 120% of maximum Leader_Code
#define SS_Leader_Max	267300			// 110% of Leader_Code for Samsung
#define SS_Leader_Min	218700			//  90% of Leader_Code
#define LG_Leader_Max	400950			// 110% of Leader_Code for LG
#define LG_Leader_Min	328050			//  90% of Leader_Code
#define Low_Bit_Max	33413			// 110% of Low_Bit_Code
#define Low_Bit_Min	27337			//  90% of Low_Bit_Code
#define High_Bit_Max	66825			// 110% of High_Bit_Code
#define High_Bit_Min	54675			//  90% of High_Bit_Code
...
int main(void)
{
  ...
  SysTick->CTRL  = 0x00000003;			// 216MHz/8 = 27MHz, 37.0ns clock
